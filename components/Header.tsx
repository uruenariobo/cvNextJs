...
const Header = () => {
  ...
  return (
    <div className="w-[970px] h-[467.09px] relative">
      ...
      <img className="w-[325.72px] h-[459.09px] left-[592px] top-[8px] absolute" src="https://media.licdn.com/dms/image/D4E03AQH9OLlY7HkdLg/profile-displayphoto-shrink_800_800/0/1681477984393?e=1702512000&v=beta&t=gxWPc9MHU-YicDsS3QBNQuYO8uJaqjyvkce8zTtddTQ" />
